...
export function TaskFilterMenu({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 hidden items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="filter-menu-title">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 transform transition-transform duration-200 scale-100">
        <h3 id="filter-menu-title" className="text-lg font-semibold text-foreground mb-4">
          Filter
        </h3>
